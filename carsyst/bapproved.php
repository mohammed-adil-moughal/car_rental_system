...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                          ...
                          <li>
                              <a href="bapproved.php"><i class="fa fa-table fa-fw"></i> Approved Bookings &nbsp&nbsp >></a>
                        </li>
                          <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Booking Records</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        All the bookings that have been Recorded in the system and Approved 
                        </div>
...
<?php
 ...
 $link= mysqli_connect("localhost", "root", "","phpgang") ;
      if($link->connect_error){
         ...
         $sql="SELECT * FROM booking,drop_off,pick where (status='approved' and booking.pick_location=pick.id and booking.drop_location=drop_off.id)";
    ...
    for($i=0;$i=$result->fetch_assoc();$i++)
{
    ...
    {  
     ...
     $good=$dr-$day;
      ...
      echo"<td >";echo "" .$i["pick"];
      if($good>0 ){echo"<td style=color:RED>";echo "" .$i["drop_date"];}
      else{echo"<td style=color:blue>";echo "" .$i["drop_date"];}
      echo"<td >";echo "" .$i["drop_o"];
     
      echo"<td>";echo date('Y m d H:i:s',$i["timestamp"]);
       echo '<td><a title="DELETE"  class="btn btn-default"href="deletebooking.php?id=' . $i['reg_no'] . '"><i class="fa  fa-trash-o  fa-fw"></i></a></td>';
