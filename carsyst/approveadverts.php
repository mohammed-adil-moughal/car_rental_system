...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="approveadverts.php"><i class="fa fa-exclamation fa-fw"></i> Pending Adverts &nbsp&nbsp >></a>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Unapproved Advertisements</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php
 ...
 $link= mysqli_connect("localhost", "root", "","phpgang") ;
      if($link->connect_error){
         ...
         $sql="SELECT * FROM addetails where approved='no'";
    ...
    for($i=0;$i=$result->fetch_assoc();$i++)
{
    ...
    $src=$file_path.$i['image'];
     ...
     echo '<td style="color: red"><a class="btn btn-default" title="apporove"style="color: blue"href="approvead.php?id=' . $i['ad_id'] . '"><i class="fa   fa-check   fa-fw"></i></a></td>';
      echo '<td><a  class="btn btn-default" title="reject" data-toggle="tooltip" data-placement="top" style="color: red" href="rejectad.php?id=' . $i['ad_id'] . '"><i class="fa    fa-times    fa-fw"></i></a></td>';
