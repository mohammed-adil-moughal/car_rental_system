...
<div class="wrapper col4" style="margin-bottom: 0%;font-family: cursive;opacity: 0.50">
    ...
    <ul>
      ...
      <li><a href="">Vehicles</a></li>
       <li>&#187;</li>
       <li><a href="userviewavailablecars.phpcars.php">Available vehicles</a></li>
...
<div class="wrapper col6" style="background-image: url(images/f2.jpg);	background-attachment: fixed;background-repeat: no-repeat;background-size: 100%;color: black">
    <h2 style="text-align: center;"></h2>
        ...
        <div class="container" style="text-align: center">
           ...
           <div class="input-group" style="margin-left: 20%;margin-right:0%;margin-bottom:20px;">
        <div class="input-group-addon">Browse  by Category</div>
<!--            <select name="box1"  onchange="show()" class="form-control" style="width: 20%;margin-left: 40%;margin-bottom: 2%">
